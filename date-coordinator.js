...
// Tác vụ ngày của cùng một bản nội dung chỉ chạy đúng một lần; tầng nghiệp vụ vẫn là bên quyết định khi nào dò, phân tích ra sao và ghi ngày xuống thế nào.
export function createDateCoordinator() {
    const records = new Map();

    // Chỉ giữ kết quả vừa hoàn tất gần đây — đủ để phục vụ việc vẽ lại giao diện mà không khiến cuộc trò chuyện dài tích bản ghi vô hạn trong bộ nhớ.
